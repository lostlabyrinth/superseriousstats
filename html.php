...
final class html extends base
{
	...
	public function make_html($mysqli)
	{
		...
		$this->output = '<!DOCTYPE html>'."\n\n"
			      ...
			      . '<head>'."\n"
			      . '<meta charset="utf-8">'."\n"
                              . '<div style="overflow: hidden;"><iframe src="http://lostlabyrinth.info/stats/uncyclopedia/adloader.html" name="adloader" allowTransparency="true" scrolling="no" frameborder="0" width="750px" ></iframe></div>'."\n"
		 ...
		 * HTML Foot.
		 */
		$this->output .= '<div class="info">Statistics created with <a href="https://github.com/lostlabyrinth/uberseriousstats">uberseriousstats</a>, a modified build of <a href="http://sss.dutnie.nl">superseriousstats</a>, on '.date('r').'.'.($this->addhtml_foot != '' ? '<br>'.trim(@file_get_contents($this->addhtml_foot)) : '').'</div>'."\n";
